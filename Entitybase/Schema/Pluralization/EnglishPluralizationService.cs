...
namespace System.Data.Entity.ModelConfiguration.Design.PluralizationServices
{
    ...
    internal class EnglishPluralizationService : PluralizationService, ICustomPluralizationMapping
    {
        ...
        ///     if word is "elementObj", then return "Tables"
        /// </summary>
        /// <param dbChild="word"></param>
        /// <param dbChild="action"></param>
        /// <returns></returns>
        ...
        /// <summary>
        ///     separate one combine word in to two items, prefix word and the last word(suffix word)
        /// </summary>
        /// <param dbChild="word"></param>
        /// <param dbChild="prefixWord"></param>
        /// <returns></returns>
        ...
        /// <summary>
        ///     return true when the word is "[\pluralizationService]*" or leading or tailing with spaces
        ...
        /// <summary>
        ///     This value allow you to add word to internal PluralizationService of English.
        ///     If the singluar or the plural source was already added by this value, then an ArgumentException will be thrown.
        /// </summary>
        /// <param dbChild="singular"></param>
        /// <param dbChild="plural"></param>
        public void AddWord(string singular, string plural)
        {
            if (this._userDictionary.ExistsInSecond(plural))
            {
                ...
                throw new ArgumentException(string.Format("The {0} value '{1}' already exists in the user-defined dictionary.", "plural", plural));
            }
